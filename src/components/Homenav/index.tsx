...
const Homenav = (props: Props) => {
  ...
  return (
    <main>
      <nav className="flex justify-between px-8 items-center py-6  bg-gradient-to-r from-white from-10% via-white via-40% to-sky-200 ">
        ...
        <div
          className={clsx(
            " fixed h-full w-screen lg:hidden bg-black/50  backdrop-blur-sm top-0 right-0  -translate-x-full  transition-all z-20 ",
