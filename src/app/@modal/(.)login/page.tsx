...
//       <div className="bg-yellow-300 w-full h-40 mb-8 py-10 sm:px-8 md:px-16 lg:px-24 xl:px-56">
...
//               <span className="text-yellow-500">Glossy</span>Labs
//             </div>
//             <div className="py-10">
...
//                 <a
//                   href="#"
//                   className="border-gray-200 border-2 bg-yellow-300 rounded-full p-3 mx-1"
//                 >
//                   <FaFacebookF />
//                 </a>
//                 <a
...
//                   </a>
//                 </div>
//                 <div className="border-2 border-black text-black-500 rounded-full px-8 py-2 inline-block font-semibold hover:bg-yellow-500 hover:text-white">
...
//           <div className="w-full sm:w-2/5 bg-yellow-400 text-black rounded-tr-2xl rounded-br-2xl py-8 px-4 sm:py-36 sm:px-8">
