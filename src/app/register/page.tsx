        ...
        <div className="bg-white rounded-2xl shadow-2xl flex flex-col sm:flex-row w-full sm:w-2/3 max-w-4xl">
          <div className="w-full sm:w-3/5 p-5">
            <div className="text-left font-bold">
              <span className="text-yellow-300">Glossy</span>Labs
            </div>
            <div className="py-10">
              ...
              <div className="flex flex-col items-center sm:border-yellow-500 mt-10">
                ...
                <a
                  href="#"
                  className="border-2 border-black text-black-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-yellow-500 hover:text-white mt-5"
                >
                  Submit
                </a>
              </div>
